...
# -*- coding: utf-8 -*-
#
# Pyforms Web documentation build configuration file, created by
...
project = 'Pyforms Web'
copyright = '2017, Ricardo Jorge Vieira Ribeiro'
...
html_logo = '_static/imgs/pyforms-web-small.jpg'
...
latex_documents = [
    (master_doc, 'PyformsWeb.tex', 'Pyforms Web Documentation',
