...
The framework aims to boost the development productivity by providing an API in Python that generates HTML Forms and manages all the client\server communications.
